...
import { Building2, Plus, Trash2, Save, Pencil, X, Loader2 } from 'lucide-react';
import { useBuildingConfig, Entrance } from '../../lib/hooks/useBuildingConfig';
    ...
    <div className="p-6">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• Филтрите за входове и етажи ще показват само наличните опции</li>
          <li>• Трябва да има поне един вход в конфигурацията</li>
        </ul>
      </div>
    </div>
  );
